...
export class FruitsListPage implements OnInit {
  ...
  public sayHello = (name: string) => console.log(name);
  ...
  public callFunction(callback: (str: string) => void) {
    callback('Juanito');
  }

  public deleteFruit(index: number, name: string): void {

    console.log('TODO: delete fruit index', index, name);
  }
}
